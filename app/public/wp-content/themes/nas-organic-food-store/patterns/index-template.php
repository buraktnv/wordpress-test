 ...
 * Slug: nas-organic-food-store/index-template
...
<h2 class="wp-block-heading has-text-align-center" style="font-size:48px"><?php echo esc_html__( 'Organic Food Store\'s Blog', 'nas-organic-food-store' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"nas-organic-food-store","area":"sidebar"} /--></div>
<!-- /wp:column -->
